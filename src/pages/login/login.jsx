...
import { TextField, Button, IconButton, InputAdornment, Typography, Box, Container, Paper } from "@mui/material";
  ...
  return (
    ...
    >
      <Paper
        elevation={3}
        sx={{
          width: 400, // Exact width of the card
          height: 450, // Exact height of the card
          padding: 4,
          borderRadius: 2,
          display: "flex",
